  ...
  if (isMobile) {
    return (
      ...
      >
        ...
        <div
          ref={mobileScrollRef}
          className="flex overflow-x-auto snap-x snap-mandatory pt-16 pb-28"
          style={{
            height: "100vh",
            width: "100vw",
            scrollbarWidth: "none",
        ...
        <div className="fixed bottom-[4.75rem] left-0 right-0 flex justify-center pointer-events-none z-10 xl:bottom-4">
