...
const ContactForm = () => {
  ...
  return (
    <>
      <section className="bg-[#211E1F] text-[#C4C2B7] font-sans min-h-screen overflow-x-hidden">
        {/* Top Bar */}
        <div
          ref={topBarRef}
        ...
        <div className="mt-20 flex flex-col items-center justify-center text-center px-4 perspective-1000">
          <h1
            ref={heroTitleRef}
            className="text-[clamp(2rem,12vw,100px)] font-bold text-[#C2C1BA] leading-tight cursor-default hover:text-white transition-colors duration-300"
        ...
        {/* Client Inquiry Form */}
        <div className="mt-20 max-w-4xl mx-auto px-4 sm:px-6 pb-24 md:pb-20">
          <div
            ref={formRef}
            className="bg-linear-to-br from-[#C4C2B7]/5 to-[#C4C2B7]/10 backdrop-blur-sm rounded-3xl p-5 sm:p-8 border border-[#C4C2B7]/20 shadow-2xl"
            style={{ transformStyle: "preserve-3d" }}
          >
